...
class ResetPasswordBloc extends Bloc<ResetPasswordEvent, ResetPasswordState> {
  ...
  ResetPasswordState _mapEmailChangedToState(
      ResetPasswordEmailChanged event, ResetPasswordState state) {
  ...
  Stream<ResetPasswordState> _mapResetPasswordSubmittedToState(
      ResetPasswordSubmitted event, ResetPasswordState state) async* {
